...
public abstract class BaseServiceImpl<T> implements BaseService<T> {
    ...
    @Override
    public PageResult<T> selectPageByProperty(T record, Integer pageSize, Integer pageNum) {
    ...
    @Override
    public PageResult<T> selectPageByFunc(ListFunc<T> func, Integer pageSize, Integer pageNum) {
        PageHelper.startPage(pageNum, pageSize);
