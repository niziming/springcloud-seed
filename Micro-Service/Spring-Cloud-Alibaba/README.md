# Spring Cloud Alibaba基于Alibaba的微服务解决方案
...
为 Spring Cloud Alibaba 贡献代码请参考 [如何贡献](https://github.com/alibaba/spring-cloud-alibaba/wiki/如何贡献代码) 。
...
![image-20211102144135711](README/image-20211102144135711.png)
...
利用该项目可以快速搭建Spring Cloud微服务项目的骨架。
版本：
